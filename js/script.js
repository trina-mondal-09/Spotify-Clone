...
async function getSongs(folder) {
  ...
  for (const song of songs) {
    ...
    <div class="playnow">
      <span>Play Now</span>
      <img class="invert" src="img/play.svg" height="24px" width="24px" alt="">
    </div>
  </li>`;
  }
...
async function displayAlbums() {
  ...
  Array.from(document.getElementsByClassName("card")).forEach((e) => {
    e.addEventListener("click", async (item) => {
      ...
      // songs[0](document.querySelector(".playnow>img").src.replace("img/play.svg", "img/pause.svg"))
    });
  });
}
...
async function main() {
  ...
  // Add aevent listener to a seekbar
  ...
  // Add an evnt listener for cross button
